 ...
 */
function getLTCornerColors(colors) {
  /**
 ...
 * @returns 指纹
 */
function getFingerprint(imgData) {
  const colors = getLTCornerColors(getDCT(getGrayscale(imgData))); // 颜色集合
 ...
 */
const compareImageSimilarity = async function (imageA, imageB) {
